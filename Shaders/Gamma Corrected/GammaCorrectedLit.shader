Shader "Universal Render Pipeline/Lit (Gamma Corrected)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment LitPassFragmentGamma
			
			#define FORWARD_PASS

			#include "GammaCorrected.hlsl"
        ...
        Pass
        {
            ...
            #pragma fragment LitGBufferPassFragmentGamma
        ...
        Pass
        {
			...
			#include "GammaCorrected.hlsl"
			#include "Assets/ThirdParty/UnityUniversalRPSurfaceShader/Shaders/URPSurfaceShaderMetaPass.hlsl"
